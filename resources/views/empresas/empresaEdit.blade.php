                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('empresas.update', $empresa) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="razao_social" class="block mt-1 w-full" type="text" name="razao_social" :value="old('razao_social', $empresa->razao_social)" required autofocus autocomplete="organization" maxlength="255" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nome_fantasia" class="block mt-1 w-full" type="text" name="nome_fantasia" :value="old('nome_fantasia', $empresa->nome_fantasia)" autocomplete="organization-title" maxlength="255" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="cnpj" class="block mt-1 w-full" type="text" name="cnpj" :value="old('cnpj', $empresa->cnpj)" placeholder="00.000.000/0000-00" required autocomplete="off" />
